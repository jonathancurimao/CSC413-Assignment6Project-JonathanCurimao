...
public class CustomerList extends javax.swing.JFrame {
    ...
    private void showCustomerDetail() {
        int selectedIndex = custList.getSelectedIndex();
        if (selectedIndex != -1) {
            BankCustomer selectedCustomer = customers.get(selectedIndex);
            CustomerDetail customerDetail = new CustomerDetail(selectedCustomer);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new CustomerList(customers).setVisible(true);
            }
        });
    }
