...
public class HomePage extends JFrame implements ActionListener {
    ...
    HomePage() {
        ...
        jbSearch = new JButton("Show all Customers");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if((ae.getSource()) == jbAdd) { 
            ...
            // Fetch all customers and display them in CustomerList
            List<BankCustomer> customers = CustomerDTO.getAllCustomers();
    ...
    //This frame(window) will be called as a result of an action(click, select etc) from another widget on another winhow during the GUI workflow
