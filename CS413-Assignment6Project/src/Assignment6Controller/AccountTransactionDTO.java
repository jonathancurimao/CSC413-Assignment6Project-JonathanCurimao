...
public class AccountTransactionDTO {
    ...
    public static int performCreate(HashMap hm) {
        ...
        at.setCreateDate((Timestamp)hm.get("create_date"));
        at.setAmount((double)hm.get("amount"));
        at.setDescription((String)hm.get("summary"));
        at.setID((int)hm.get("acct_id"));
        at.setType((String)hm.get("tran_type"));
    ...
    public static List<BankAccountTransaction> findTransactionByAccountId(int accountId) {
        try {
            return ato.getTransactionsByAccountId(accountId);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error retrieving transactions: " + e.getMessage());
